...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0114709/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
```{r}
# Save as CSV
write.csv(TOY_STORY, file = "TOYSTORY.csv", row.names = FALSE)
```
