...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0398286/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(TANGLED, file = "TANGLED.csv", row.names = FALSE)
```
