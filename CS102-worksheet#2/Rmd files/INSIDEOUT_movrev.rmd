...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt2096673/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(INSIDEOUT, file = "INSIDEOUT.csv", row.names = FALSE)
```
