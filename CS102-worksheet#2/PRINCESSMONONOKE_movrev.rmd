---
title: "PRINCESSMONONOKE_movrev.rmd"
...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0119698/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(PRINCESSMONONOKE, file = "PRINCESSMONONOKE.csv", row.names = FALSE)
```

```{r}
# Print the data frame
print(PRINCESSMONONOKE)
View(PRINCESSMONONOKE)
```