...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0382932/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(RATATOUILLE, file = "RATATOUILLE.csv", row.names = FALSE)
```
