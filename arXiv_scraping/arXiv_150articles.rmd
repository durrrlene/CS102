...
write.xlsx(papers, "ComputerScience_articles.xlsx")
write.csv(papers, file = "ComputerScience_articles.csv")
read.csv("ComputerScience_articles.csv")
```
