...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0096283/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(TOTORO, file = "TOTORO.csv", row.names = FALSE)
```
