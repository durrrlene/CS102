...
```{r}
#for pagination URL
toyStory <- 'https://www.imdb.com/title/tt0245429/reviews/_ajax?ref_=undefined&paginationKey=%s' 
```
...
```{r}
# Save as CSV
write.csv(SPIRITEDAWAY, file = "SPIRITEDAWAY.csv", row.names = FALSE)
```
